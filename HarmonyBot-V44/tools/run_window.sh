...
case "$FAM" in
 ...
 FULL_V44) CANONICAL=true; MULTISCALE=true; DEDUPE=true; NATIVE=true; LOGICALGRID=true; AUCTION=true; RESCUE=true; OCMODEL=true; FOLLOW=true; THESISEXIT=true;;
...
cp "$C/HarmonyBot-V44/dist/HarmonyBot_V44_Canonical_Harmonic_Opportunity_Engine_RC.algo" "$W/seal/algo/"
...
(
 ...
 TTL=8 MAXCAND=12 BACKTEST_TIMEOUT_SECONDS=1800 "$C/HarmonyBot-V44/tools/run_backtest.sh"
)
