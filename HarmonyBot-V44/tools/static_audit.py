...
checks={
 ...
 "pattern_hypothesis_set":"EnablePatternHypothesisSet" in s and "SelectContextualHypothesis" in s and "HypothesisNames" in s,
 "structural_context_vector":"EnableStructuralContextVector" in s and "StructuralContextConfidence" in s and "HtfAgreement" in s,
 "pattern_temporal_state":"EnablePatternTemporalStateMachine" in s and "UpdatePatternTemporalState" in s,
 "cross_regime_admission":"EnableCrossRegimeAlphaAdmission" in s and "CrossRegimeAlphaEligible" in s,
 "robust_alpha_density":"EnableRobustAlphaDensity" in s and "RobustAlphaDensityScore" in s,
 "event_driven_auction":"EnableEventDrivenOpportunityAuction" in s and "[V43-AUCTION]" in s,
 "opportunity_loss_ledger":"EnableOpportunityLossLedger" in s and "[V43-OPPORTUNITY-LOSS]" in s,
 "portfolio_gate_wired":"if (!PortfolioExecutionEligible(c))" in s,
 "thesis_modes":"enum ThesisMode" in s and "CONTINUATION_PULLBACK" in s and "COUNTERTREND_EXHAUSTION" in s and "REGIME_TRANSITION" in s,
 "trend_relation":"enum SignalTrendRelation" in s and "ClassifySignalTrendRelation" in s,
 "thesis_consistent_routing":"EnableThesisConsistentRouting" in s and "ClassifyThesisMode" in s,
 "persistence_hazard":"TrendPersistenceHazard" in s and "ReversalPlausibilityScore" in s,
 "continuation_resumption":"ContinuationResumptionScore" in s and "EnableContinuationResumptionProof" in s,
 "grid_failure_attribution":"GridFail" in s and "[V44-GRID-FAIL]" in s,
 "l0_physical_recovery":"EnableGridL0PhysicalRecovery" in s and "[V44-GRID-RECOVERY]" in s,
...
out={"version":"HarmonyBot V44","architecture":"THESIS_CONSISTENT_ROUTE_PHYSICAL_GRID_PORTFOLIO","checks":checks,"pass":all(checks.values())}
