...
namespace cAlgo.Robots
{
    ...
    {
        private const string Version = "HarmonyBot V48 — Pattern-Family Native Conversion Engine";
        ...
        protected override void OnStart()
        {
            ...
            Print("[V48-FAMILY-NATIVE] conversion={0} observation={1} principle=PATTERN_IDENTITY_NEQ_EXECUTION_IDENTITY", EnableFamilyNativeConversion, EnableFamilyNativeObservation);
