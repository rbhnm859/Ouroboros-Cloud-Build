...
TRADING="${TRADING:-true}"; FAMILYBOOKS="${FAMILYBOOKS:-true}"; SHADOW="${SHADOW:-true}"; CALADMIT="${CALADMIT:-false}"; FAMREP="${FAMREP:-true}"; RESEARCHCONT="${RESEARCHCONT:-true}"
