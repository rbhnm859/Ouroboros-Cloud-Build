...
out={"version":"HarmonyBot V57","families":families,"checks":checks,"pass":all(checks.values())}
pathlib.Path("V57_DETECTOR_CONTRACT_TEST.json").write_text(json.dumps(out,indent=2))
