...
ALGO="${ALGO:-seal/algo/HarmonyBot_V66_Harmonic_Evidence_Accumulator_RC.algo}"
IMAGE="${CTRADER_IMAGE:-ghcr.io/spotware/ctrader-console:5.9.11}"
BACKTEST_TIMEOUT_SECONDS="${BACKTEST_TIMEOUT_SECONDS:-2700}"
case "$V66MODE" in V66_PRODUCT|V66_V64_CONTROL) ;; *) echo "invalid V66 mode $V66MODE" >&2; exit 66;; esac
