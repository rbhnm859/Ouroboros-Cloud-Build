...
out={"version":"HarmonyBot V55","families":families,"checks":checks,"pass":all(checks.values())}
pathlib.Path("V55_DETECTOR_CONTRACT_TEST.json").write_text(json.dumps(out,indent=2))
