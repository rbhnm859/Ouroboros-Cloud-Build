...
ALGO="${ALGO:-seal/algo/HarmonyBot_V51_Family_Native_Math_Geometry_Economic_Conversion_RC.algo}"
...
test "$DONE" = 1 || { echo "[V51-WATCHDOG-FAIL] run=$RUN_NAME"; tail -400 "seal/logs/$RUN_NAME.log" || true; exit 20; }
echo "[V51-WATCHDOG] run=$RUN_NAME status=complete"
