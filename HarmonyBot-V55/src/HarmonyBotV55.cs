...
namespace cAlgo.Robots
{
    ...
    public class HarmonyBotV55 : Robot
    {
        ...
        protected override void OnStart()
        {
            ...
            Print("[V55-DETECTOR-ARCH] identityReconstruction={0} boundedPivotGraph={1} maxMicroSkips={2} familyQuota={3} projectedPrz={4} truthLedger={5} rule=DETECT_MANY_EXECUTE_ONE",
            ...
            Print("[V55-CONVERSION-ARCH-V2] qualification={0} router={1} confirmation={2} contextBus={3} gridExecution={4} rule=FAMILY_NATIVE_POST_DETECTOR_CAUSAL_ISOLATION",
        ...
        private bool TryBuildFibonacciGridPlan(CandidateRecord c)
        {
            ...
            double[] activeFractions = EnableFamilyGridAlphaCoreV3 ? FamilyGridFractionsV3(c.Signal.PatternName, p.GridFractions) : p.GridFractions;
            double[] activeWeights = EnableFamilyGridAlphaCoreV3 ? FamilyGridRiskWeightsV3(c.Signal.PatternName, activeFractions.Length) : p.GridRiskWeights;
        ...
        private void CloseBasketLedger(FibonacciBasket basket, string reason)
        {
            ...
            Print("[V55-BASKET-CLOSED] basket={0} cid={1} setup={2} pattern={3} subtype={4} route={5} dir={6} plannedLegs={7} filledLegs={8} anchor={9} avgEntry={10} entryImprovePips={11:F3} stop={12} target={13} initialRisk={14:F2} worstRisk={15:F2} mfeR={16:F3} maeR={17:F3} realizedR={18:F3} net={19:F2} reason={20}",
    ...
    public sealed class CandidateRecord
    {
        ...
        public double AlphaQualityScore, RegimeScore, ContextScore, FamilyQualificationScore, CoreAlphaScore, CapitalMinL0Risk, CapitalMinL0Margin;
        public bool LiberationShadowQuality, LiberationShadowRoute;
