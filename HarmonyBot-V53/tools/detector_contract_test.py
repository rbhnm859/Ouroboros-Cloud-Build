...
out={"version":"HarmonyBot V53","families":families,"checks":checks,"pass":all(checks.values())}
pathlib.Path("V53_DETECTOR_CONTRACT_TEST.json").write_text(json.dumps(out,indent=2))
