...
ALGO="${ALGO:-seal/algo/HarmonyBot_V53_Family_Native_Conversion_Grid_Causal_RC.algo}"
...
test "$DONE" = 1 || { echo "[V53-WATCHDOG-FAIL] run=$RUN_NAME"; tail -400 "seal/logs/$RUN_NAME.log" || true; exit 20; }
echo "[V53-WATCHDOG] run=$RUN_NAME status=complete"
