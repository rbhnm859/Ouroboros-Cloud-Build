...
- Does **not** change the original execution gate order, H1/M30 order comments, entry thresholds, position limits or risk sizing.
...
The Round18 diagnostics run must reproduce Round17 economics on the same 2025-09-08 to 2026-09-08 test window:
- Standard baseline: 94 trades, ROI +38.48%, PF 1.85, max equity DD 5.9242%
- Harsh baseline: 92 trades, ROI +19.25%, PF 1.40, max equity DD 7.6690%

CI fails if trade count changes or ROI/PF/DD diverge beyond the tight neutrality tolerance. Directional expansion remains blocked until this test passes.
