...
ALGO="${ALGO:-seal/algo/HarmonyBot_V65_Harmonic_Thesis_Completion_RC.algo}"
IMAGE="${CTRADER_IMAGE:-ghcr.io/spotware/ctrader-console:5.9.11}"
BACKTEST_TIMEOUT_SECONDS="${BACKTEST_TIMEOUT_SECONDS:-2700}"
case "$V65MODE" in V65_PRODUCT|V65_V64_CONTROL) ;; *) echo "invalid V65 mode $V65MODE" >&2; exit 65;; esac
