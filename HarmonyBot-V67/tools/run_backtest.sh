...
MODE="${V67MODE:-V67_PRODUCT}"
BALANCE="${BALANCE:-10000}"
SPREAD="${SPREAD:-1}"
ALGO="${ALGO:-seal/algo/HarmonyBot_V67_V52_Throughput_Family_Native_Grid_Commercial_Breakthrough_RC.algo}"
IMAGE="${CTRADER_IMAGE:-ghcr.io/spotware/ctrader-console:5.9.11}"
BACKTEST_TIMEOUT_SECONDS="${BACKTEST_TIMEOUT_SECONDS:-2700}"
case "$MODE" in V67_PRODUCT|V67_V52_CONTROL) ;; *) echo "invalid V67 mode $MODE" >&2; exit 64;; esac
