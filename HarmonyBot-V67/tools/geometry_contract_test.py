...
checks={
 ...
 "projected_prz_code_present":"FamilyProjectedPrzCenter" in s,
 "commercial_run_must_disable_projected_prz":"projectedPrzMustRemainFalse" in s,
...
out={"version":"HarmonyBot V67","checks":checks,"pass":all(checks.values())}
pathlib.Path("V67_GEOMETRY_CONTRACT_TEST.json").write_text(json.dumps(out,indent=2))
