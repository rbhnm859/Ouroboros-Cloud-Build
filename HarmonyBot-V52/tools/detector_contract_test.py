...
out={"version":"HarmonyBot V52","families":families,"checks":checks,"pass":all(checks.values())}
pathlib.Path("V52_DETECTOR_CONTRACT_TEST.json").write_text(json.dumps(out,indent=2))
