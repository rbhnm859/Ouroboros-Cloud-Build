...
ALGO="${ALGO:-seal/algo/HarmonyBot_V52_Family_Identity_Detection_Graph_Reconstruction_RC.algo}"
...
test "$DONE" = 1 || { echo "[V52-WATCHDOG-FAIL] run=$RUN_NAME"; tail -400 "seal/logs/$RUN_NAME.log" || true; exit 20; }
echo "[V52-WATCHDOG] run=$RUN_NAME status=complete"
