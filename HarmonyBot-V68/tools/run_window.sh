...
case "$VAR" in
 A_V52_EXACT_CONTROL)
   ...
   PQUEUE=false; HANDOFF=false; DECAY=false; REVALIDATE=false; MAXDD=10;;
 B_FAMILY_GRID_ATLAS)
   FAMNATIVE=true; CONTRACTS=true; FRONTIER=true; FGRID=false; EVIDENCE=true; EXPAND=false; ATLAS=true; POSITIVE=false; SCHED=false
   PQUEUE=false; HANDOFF=false; DECAY=false; REVALIDATE=false; MAXDD=6;;
 ...
 D_FAMILY_PORTFOLIO_MAX)
   ...
   PQUEUE=true; HANDOFF=true; DECAY=true; REVALIDATE=true; MAXDD=6;;
