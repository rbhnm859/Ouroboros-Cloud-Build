...
namespace cAlgo.Robots
{
    ...
    {
        private const string Version = "HarmonyBot V63 — Regime-Native Alpha Portfolio & Adaptive Execution Governor";
        ...
        private bool V63GoldenControlEnabled()
        {
