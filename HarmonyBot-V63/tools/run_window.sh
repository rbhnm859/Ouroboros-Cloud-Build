...
case "$VAR" in V63_CONDITIONAL_EXECUTION|V63_CELL_POLICY_ROUTER|V63_CELL_POLICY_RUNNER|V63_POSITIVE_COHORT_RECOVERY|V63_OCCUPANCY_GOVERNOR) ;; *) echo "unsupported V63 variant $VAR" >&2; exit 31;; esac
...
cp "$C/HarmonyBot-V63/dist/HarmonyBot_V63_Regime_Native_Alpha_Portfolio_Adaptive_Execution_Governor_RC.algo" "$W/seal/algo/"
