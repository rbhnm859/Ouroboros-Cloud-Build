...
test "$DONE" = 1 || { echo "[V56-WATCHDOG-FAIL] run=$RUN_NAME"; tail -400 "seal/logs/$RUN_NAME.log" || true; exit 20; }
echo "[V56-WATCHDOG] run=$RUN_NAME status=complete"
