...
V54LIB="${V54LIB:-false}"; V54CORE="${V54CORE:-false}"; V54ECON="${V54ECON:-false}"; V54FGRID="${V54FGRID:-false}"; V54SAGRID="${V54SAGRID:-false}"
ALGO="${ALGO:-seal/algo/HarmonyBot_V54_Universal_Harmonic_Grid_Alpha_Core_RC.algo}"
