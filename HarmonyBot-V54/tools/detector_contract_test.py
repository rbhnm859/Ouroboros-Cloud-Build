...
out={"version":"HarmonyBot V54","families":families,"checks":checks,"pass":all(checks.values())}
pathlib.Path("V54_DETECTOR_CONTRACT_TEST.json").write_text(json.dumps(out,indent=2))
