...
BALANCE="${BALANCE:-10000}"; SPREAD="${SPREAD:-1}"; V62VARIANT="${V62VARIANT:-V62_V51_EXACT_CONTROL}"
ALGO="${ALGO:-seal/algo/HarmonyBot_V62_Alpha_Preserving_Execution_Conversion_Rebuild_RC.algo}"; IMAGE="${CTRADER_IMAGE:-ghcr.io/spotware/ctrader-console:5.9.11}"; BACKTEST_TIMEOUT_SECONDS="${BACKTEST_TIMEOUT_SECONDS:-2700}"
