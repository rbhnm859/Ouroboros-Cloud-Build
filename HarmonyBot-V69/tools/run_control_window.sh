...
result={
  ...
  "valid":not missing and valid_rows and basket_match,
  "rule":"ONE_IMMUTABLE_CONTROL_RUN_PER_ISOLATED_JOB;FAIL_CLOSED_ON_REPORT_STRUCTURE;ENGINEERING_CLEAN_RECORDED_SEPARATELY;CROSS_WINDOW_GATE_OWNS_HISTORICAL_REPRODUCTION"
}
