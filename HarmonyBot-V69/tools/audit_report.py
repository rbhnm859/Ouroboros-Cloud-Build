...
def label_basket(label):
    ...
    if len(p)>=3 and p[0] in ("HB52","HB67","HB68","HB69"): return p[1]
    return ""
def kv_comment(c):
    z={}
...
out={
 ...
 "engineering_clean":engineering,"summary_present":bool(summary),"broker_profile_present":("[V69-BROKER-PROFILE]" in t or "[V68-BROKER-PROFILE]" in t or "[V67-BROKER-PROFILE]" in t or "[V52-BROKER-PROFILE]" in t),
