...
src=src.replace("HarmonyBot_V52_Family_Identity_Detection_Graph_Reconstruction_RC.algo",
                "HarmonyBot_V69_Family_Alpha_Federation_Commercial_Breakthrough.algo")
src=src.replace('--MicroCapitalThreshold=500 --MaxDrawdownPercent=10 --DailyLossLimitPercent=2',
