    ...
    public class CumulativeDeltaScalper_EURUSD_v1 : Robot
    {
        ...
        private int CheckSignal()
        {
            ...
            if (signal < 0 && UseStrictShortFilter)
            {
                ...
                if (ClosedHtfAdx() < AdxThreshold + Math.Max(0.0, ShortAdxBonus)) return 0;
        ...
        private void ManageRunnerExit(Position position)
        {
            ...
            {
                double trailPips = PriceDistanceToPips(ClosedAtr() * RunnerTrailAtrMultiplier);
        ...
        private double EstimateRiskPips(Position position)
        {
            ...
            return PriceDistanceToPips(ClosedAtr() * SlAtrMultiplier);
        }
