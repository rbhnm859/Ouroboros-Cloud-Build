...
namespace cAlgo.Robots
{
    ...
    public class CumulativeDeltaScalper_EURUSD_K2 : Robot
    {
        private const string Prefix = "[CDScalper-EURUSD-K2] ";
        private const int AtrPeriod = 14;
        private const int EmaPeriod = 50;
        private const int AdxPeriod = 14;

        [Parameter("Bot Label", DefaultValue = "CDScalper_EURUSD_K2", Group = "General")]
        ...
        [Parameter("Min ExpectedMove/Cost", DefaultValue = 2.0, MinValue = 1.0, Step = 0.1, Group = "Execution")]
        ...
        [Parameter("Risk Mode", DefaultValue = CdsK2RiskMode.FixedMoneyRisk, Group = "Risk")]
        public CdsK2RiskMode RiskMode { get; set; }
        ...
        protected override void OnStart()
        {
            ...
            {
                Print(Prefix + "K2 commercial research requires EURUSD M1.");
                Stop();
                return;
            }
            ...
            RestoreRuntimeState();
            Debug("started; K entry core preserved; cost-aware gate + ATR BE + closed-bar adverse exit enabled");
        }
        ...
        private void OpenTrade(int signal)
        {
            ...
            {
                Skip("cost_gate_ratio_" + ratio.ToString("F2"));
                return;
            }
        ...
        {
            if (RiskMode == CdsK2RiskMode.FixedLots) return 0;
            if (RiskMode == CdsK2RiskMode.RiskPercent) return Account.Balance * RiskPercentPerTrade / 100.0;
        ...
        {
            if (RiskMode == CdsK2RiskMode.FixedLots)
        ...
        private double PriceDistanceToPips(double d)
        {
            return d / Symbol.PipSize;
        }
