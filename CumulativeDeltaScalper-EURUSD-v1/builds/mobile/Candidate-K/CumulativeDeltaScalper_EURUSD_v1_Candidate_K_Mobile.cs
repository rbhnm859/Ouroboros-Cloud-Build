...
namespace cAlgo.Robots
{
    ...
    public class CumulativeDeltaScalper_EURUSD_v1 : Robot
    {
        ...
        [Parameter("Bot Label", DefaultValue = "CDScalper_Candidate_K_Mobile", Group = "General")]
        ...
        [Parameter("Allow M5", DefaultValue = false, Group = "General")]
        public bool AllowM5 { get; set; }

        [Parameter("Allow M15", DefaultValue = false, Group = "General")]
        public bool AllowM15 { get; set; }

        [Parameter("Allow M30", DefaultValue = false, Group = "General")]
        ...
        [Parameter("Min Confirmations", DefaultValue = 3, MinValue = 0, MaxValue = 5, Group = "Delta")]
        ...
        [Parameter("Use Weekday Filter", DefaultValue = true, Group = "Weekday Filter")]
        ...
        [Parameter("Min ATR", DefaultValue = 0.00005, MinValue = 0.0, Step = 0.00005, Group = "Filters")]
        public double MinAtr { get; set; }

        [Parameter("Max ATR", DefaultValue = 0.00105, MinValue = 0.0, Step = 0.00005, Group = "Filters")]
        ...
        [Parameter("Max Daily Equity DD Money", DefaultValue = 0.75, MinValue = 0.0, Step = 0.01, Group = "Equity Protection")]
        public double MaxDailyEquityDrawdownMoney { get; set; }

        [Parameter("Max Floating Loss Money", DefaultValue = 0.90, MinValue = 0.0, Step = 0.01, Group = "Equity Protection")]
        public double MaxFloatingLossMoney { get; set; }

        [Parameter("Max Equity DD %", DefaultValue = 12.0, MinValue = 0.0, Step = 0.1, Group = "Equity Protection")]
        ...
        [Parameter("Breakeven Pips", DefaultValue = 1.0, MinValue = 0.1, Step = 0.1, Group = "Exit")]
