...
NATIVEBARS="${NATIVEBARS:-4}"; DECAY="${DECAY:-false}"; HARDLIFE="${HARDLIFE:-180}"; FAMNATIVE="${FAMNATIVE:-false}"; FAMOBS="${FAMOBS:-true}"; CANCONTRACT="${CANCONTRACT:-false}"; FAMCONF="${FAMCONF:-false}"
REVALIDATE="${REVALIDATE:-false}"
ALGO="${ALGO:-seal/algo/HarmonyBot_V49_Pattern_Native_Completion_Contract_RC.algo}"
