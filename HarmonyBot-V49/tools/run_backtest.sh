...
NATIVEBARS="${NATIVEBARS:-4}"; DECAY="${DECAY:-false}"; HARDLIFE="${HARDLIFE:-180}"; FAMNATIVE="${FAMNATIVE:-true}"; FAMOBS="${FAMOBS:-true}"
REVALIDATE="${REVALIDATE:-false}"
ALGO="${ALGO:-seal/algo/HarmonyBot_V49_Pattern_Native_Confirmation_Arbitration_RC.algo}"
