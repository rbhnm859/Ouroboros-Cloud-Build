...
namespace cAlgo.Robots
{
    ...
    {
        private const string Version = "HarmonyBot V49 — Pattern-Native Completion Contract Engine";
        ...
        protected override void OnStart()
        {
            ...
            Print("[V49-COMPLETION-CONTRACT] canonicalContracts={0} familyCompletion={1} windowBars={2} provenLane=ABCD_SHARK_CYPHER_FROZEN",
        ...
        protected override void OnStop()
        {
            ...
            foreach (var p in _profiles.Select(x => x.Name).Distinct().OrderBy(x => x))
            {
                ...
                Print("[V49-FAMILY-CONTRACT-SUMMARY] pattern={0} pass={1} windowReject={2}", p, pass, reject);
            }
