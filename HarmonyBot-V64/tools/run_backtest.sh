...
BALANCE="${BALANCE:-10000}"; SPREAD="${SPREAD:-1}"; V64MODE="${V64MODE:-V64_PRODUCT}"
ALGO="${ALGO:-seal/algo/HarmonyBot_V64_XAUUSD_Harmonic_Product_Convergence_RC.algo}"
IMAGE="${CTRADER_IMAGE:-ghcr.io/spotware/ctrader-console:5.9.11}"
BACKTEST_TIMEOUT_SECONDS="${BACKTEST_TIMEOUT_SECONDS:-2700}"
case "$V64MODE" in V64_PRODUCT|V64_V51_CONTROL) ;; *) echo "invalid V64 mode $V64MODE" >&2; exit 64;; esac
