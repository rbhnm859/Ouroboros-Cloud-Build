...
ABCDLIVE="${ABCDLIVE:-false}"; V60GRID="${V60GRID:-true}"; CALMIN="${CALMIN:-0.0}"; CALMAN="${CALMAN:-}"
...
ALGO="${ALGO:-seal/algo/HarmonyBot_V60_Canonical_Harmonic_Manifold_Excursion_Capture_RC.algo}"
