...
case "$CANDIDATE" in
 V60_MANIFOLD_CAPTURE_L0) GRID=false;;
 V60_MANIFOLD_CAPTURE_LEGACY_GRID) GRID=true;;
...
ABCDLIVE=false V60GRID="$GRID" CALMIN=0.0 CALMAN="$CALMAN" MANIFOLD=true PUREPRZ=true DAG=true CAPRESEARCH=true CAPLIVE=true MATCHED=true PROJERR=.55 MSIG=1.0 \
