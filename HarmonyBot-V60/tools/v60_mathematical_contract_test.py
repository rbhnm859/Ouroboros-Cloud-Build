...
assert 'V60AbcdCenters("AB=CD")' in src
...
i=src.index("private double V60PureProjectedPrzCenter")
...
assert "V60FirstEvent" not in dag
...
u=src.index("private void UpdateV60FamilyShadowTrades")
v=src.index("private bool V60ShadowFloorHit",u)
shadow=src[u:v]
