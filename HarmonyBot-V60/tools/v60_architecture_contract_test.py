...
s=Path("HarmonyBot-V60/src/HarmonyBotV60.cs").read_text(encoding="utf-8")
checks={
"identity":"class HarmonyBotV60" in s and 'BotPrefix = "HB60"' in s,
"risk":"[Parameter(\"Basket Risk %\", DefaultValue = 1.0" in s,
"rr":"[Parameter(\"Minimum Net RR\", DefaultValue = 2.0" in s,
"family_books":"_familyBooks" in s and "EnableV60FamilyBooks" in s,
"bounded_detector":"EnumerateBoundedPivotSequences" in s and "BuildFamilyHypothesisKey" in s,
"manifold":"V60CanonicalManifoldScore" in s and "EnableV60CanonicalManifold" in s,
"pure_prz":"V60PureProjectedPrzCenter" in s and "EnableV60PureProjectedPrz" in s,
"d_not_in_projection":"projections.Add(d.Price)" not in s,
"discrete_abcd":"V60AbcdDiscreteIdentity" in s and "1.272" in s and "1.618" in s,
"temporal_dag":"EnableV60TemporalEventDag" in s and
...
"capture":"V60-CAPTURE-CLOSED" in s and "EnableV60ExcursionCaptureLive" in s and "HybridR" in s,
"abcd_capital_off":"EnableV60AbcdStandaloneCapital" in s,
...
print({"version":"HarmonyBot V60","checks":checks,"pass":not bad})
if bad: raise SystemExit("V60 architecture contract FAIL: "+",".join(bad))
