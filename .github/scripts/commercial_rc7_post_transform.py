...
tick = final_main[final_main.find('protected override void OnTick()'):final_main.find('private double Round21CalculateM30Volume')]
if 'if (!Growth2Enabled)' not in tick or 'Round21ReserveH1Lane();' not in tick or 'CommercialTryExecuteDeferredM30();' not in tick:
    raise SystemExit('RC7 control/candidate OnTick isolation missing')
