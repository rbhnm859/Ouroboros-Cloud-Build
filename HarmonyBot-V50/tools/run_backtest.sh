...
ALGO="${ALGO:-seal/algo/HarmonyBot_V50_Pattern_Native_Structural_Grid_Contract_RC.algo}"
...
test "$DONE" = 1 || { echo "[V50-WATCHDOG-FAIL] run=$RUN_NAME"; tail -400 "seal/logs/$RUN_NAME.log" || true; exit 20; }
echo "[V50-WATCHDOG] run=$RUN_NAME status=complete"
