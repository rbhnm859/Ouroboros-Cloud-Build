...
out={"version":"HarmonyBot V58","families":families,"checks":checks,"pass":all(checks.values())}
pathlib.Path("V58_DETECTOR_CONTRACT_TEST.json").write_text(json.dumps(out,indent=2))
