...
ABCDLIVE="${ABCDLIVE:-false}"; V58GRID="${V58GRID:-true}"; CALMIN="${CALMIN:-0.0}"; CALMAN="${CALMAN:-}"
...
ALGO="${ALGO:-seal/algo/HarmonyBot_V58_Canonical_Harmonic_Manifold_Excursion_Capture_RC.algo}"
...
test "$DONE" = 1 || { echo "[V58-WATCHDOG-FAIL] run=$RUN_NAME"; tail -400 "seal/logs/$RUN_NAME.log" || true; exit 20; }
echo "[V58-WATCHDOG] run=$RUN_NAME status=complete"
