...
rep={"version":"HarmonyBot V61","rows":len(rows),"cells":cells,"cluster_key":"setup","fresh_used":False}; (out/"V61_CLUSTER_EVIDENCE.json").write_text(json.dumps(rep,indent=2)); print(json.dumps(rep,indent=2))
