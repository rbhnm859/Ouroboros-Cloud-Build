...
F=["V61_V51_EXACT_CONTROL","V61_DAG_CAPITAL_CONTROL","V61_CHAMPION_FIB_GRID","V61_GRID_REGIME_SURVIVAL","V61_COMMERCIAL_MAX"]; H={"frequency":38.6666666667,"net":2101.66,"pf":2.1096878432,"expectancy":36.2355,"win_rate":.534483,"max_dd_pct":4.49784}; COMM={"max_baskets":90,"min_frequency":60.0,"net":1800.0,"pf":2.0,"expectancy":20.0,"win_rate":.50,"max_dd_pct":6.0}
def find(v,w):
...
D_DAG=delta("V61_DAG_CAPITAL_CONTROL","V61_V51_EXACT_CONTROL"); D_BA=delta("V61_CHAMPION_FIB_GRID","V61_DAG_CAPITAL_CONTROL"); D_CB=delta("V61_GRID_REGIME_SURVIVAL","V61_CHAMPION_FIB_GRID"); D_DC=delta("V61_COMMERCIAL_MAX","V61_GRID_REGIME_SURVIVAL")
...
eligible=[v for v in F[2:] if grid_pass and superior(A[v]) and commercial(A[v])]; winner=max(eligible,key=lambda v:(A[v]["net"],A[v]["pf"],A[v]["expectancy"])) if eligible else None
