...
Fixed variants: V61_V51_EXACT_CONTROL; V61_DAG_CAPITAL_CONTROL (research control: stage-aware DAG + AB=CD Capital OFF + V51 legacy grid); V61_CHAMPION_FIB_GRID; V61_GRID_REGIME_SURVIVAL; V61_COMMERCIAL_MAX.
...
Calibration-only evidence freeze sets V61 Regime Survival Threshold to 0.65. Grid causal attribution is B minus V61_DAG_CAPITAL_CONTROL; V51 exact remains the historical superiority reference.
