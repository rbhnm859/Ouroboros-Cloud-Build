...
out={"version":"HarmonyBot V59","families":families,"checks":checks,"pass":all(checks.values())}
pathlib.Path("V59_DETECTOR_CONTRACT_TEST.json").write_text(json.dumps(out,indent=2))
