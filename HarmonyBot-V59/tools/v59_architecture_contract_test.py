...
s=Path("HarmonyBot-V59/src/HarmonyBotV59.cs").read_text(encoding="utf-8")
checks={
"identity":"class HarmonyBotV59" in s and 'BotPrefix = "HB59"' in s,
"risk":"[Parameter(\"Basket Risk %\", DefaultValue = 1.0" in s,
"rr":"[Parameter(\"Minimum Net RR\", DefaultValue = 2.0" in s,
"family_books":"_familyBooks" in s and "EnableV59FamilyBooks" in s,
"bounded_detector":"EnumerateBoundedPivotSequences" in s and "BuildFamilyHypothesisKey" in s,
"manifold":"V59CanonicalManifoldScore" in s and "EnableV59CanonicalManifold" in s,
"pure_prz":"V59PureProjectedPrzCenter" in s and "EnableV59PureProjectedPrz" in s,
"d_not_in_projection":"projections.Add(d.Price)" not in s,
"discrete_abcd":"V59AbcdDiscreteIdentity" in s and "1.272" in s and "1.618" in s,
"temporal_dag":"EnableV59TemporalEventDag" in s and
...
"capture":"V59-CAPTURE-CLOSED" in s and "EnableV59ExcursionCaptureLive" in s and "HybridR" in s,
"abcd_capital_off":"EnableV59AbcdStandaloneCapital" in s,
...
print({"version":"HarmonyBot V59","checks":checks,"pass":not bad})
if bad: raise SystemExit("V59 architecture contract FAIL: "+",".join(bad))
