...
assert 'V59AbcdCenters("AB=CD")' in src
...
i=src.index("private double V59PureProjectedPrzCenter")
...
assert "V59FirstEvent" not in dag
...
u=src.index("private void UpdateV59FamilyShadowTrades")
v=src.index("private bool V59ShadowFloorHit",u)
shadow=src[u:v]
