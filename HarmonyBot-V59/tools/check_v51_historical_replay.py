...
report={"version":"HarmonyBot V51 historical replay inside V59","actual":{"baskets":n,"net":net,"pf":pf,"expectancy":exp,"win_rate":wr,"max_dd_pct":dd},"expected":expected,"checks":checks,"pass":ok}
(out/"V59_V51_HISTORICAL_REPLAY.json").write_text(json.dumps(report,indent=2))
