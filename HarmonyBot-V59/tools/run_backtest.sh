...
ABCDLIVE="${ABCDLIVE:-false}"; V59GRID="${V59GRID:-true}"; CALMIN="${CALMIN:-0.0}"; CALMAN="${CALMAN:-}"
...
ALGO="${ALGO:-seal/algo/HarmonyBot_V59_Canonical_Harmonic_Manifold_Excursion_Capture_RC.algo}"
...
test "$DONE" = 1 || { echo "[V59-WATCHDOG-FAIL] run=$RUN_NAME"; tail -400 "seal/logs/$RUN_NAME.log" || true; exit 20; }
echo "[V59-WATCHDOG] run=$RUN_NAME status=complete"
